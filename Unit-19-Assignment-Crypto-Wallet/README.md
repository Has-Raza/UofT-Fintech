...
## Results of Fintech finder app:

![Fintech finder app](Images/fintech_finder.png)
![Fintech finder transaction hash](Images/transaction_hash.png)
![Fintech finder ganache wallet](Images/ganache_account_balance.png)
